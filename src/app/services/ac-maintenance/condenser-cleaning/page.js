  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-10 items-center justify-between">
        <WhatsappButton/>
        <motion.div className="p-10 lg:w-1/2 text-justify flex flex-col gap-4"
        initial="hidden"
        animate="visible"
        ...
        >
            ...
            <ul className="list-disc flex flex-col gap-4 lg:w-1/2">
                <li><strong>Improved Energy Efficiency: </strong>Clean condenser coils allow your AC system to cool more effectively, reducing energy consumption and lowering your utility bills.</li>
                <li><strong>Enhanced Cooling Performance: </strong>A clean condenser ensures your system maintains optimal cooling, keeping your home comfortable even during the hottest days.</li>
                <li><strong>Extended Equipment Lifespan: </strong>Regular maintenance prevents strain on your system, reducing the risk of breakdowns and extending the life of your AC unit.</li>
                <li><strong>Reduced Repair Costs: </strong>Preventing dirt and debris buildup helps avoid costly repairs caused by overheating or system malfunctions.</li>
                <li><strong>Better Indoor Air Quality: </strong>A clean condenser contributes to better airflow and reduces the circulation of dust and allergens inside your home.</li>
            </ul>
        </motion.div>
        <motion.a
